...
outputs: 
  results: 
    type: File
    outputSource: trait-estimate/stage_out_results

steps:
  trait-estimate:
    run: http://awslbdockstorestack-lb-1429770210.us-west-2.elb.amazonaws.com:9998/api/ga4gh/trs/v2/tools/%23workflow%2Fdockstore.org%2Fmike-gangl%2FSBG-unity-trait-estimate/versions/3/PLAIN-CWL/descriptor/%2Fworkflow.cwl
    in:
  ...
  trait-estimate-data-catalog:
    ...
    in:
      ...
      uploaded_files_json: trait-estimate/stage_out_success
    out: [results]
